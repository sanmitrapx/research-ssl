...
case $SLURM_ARRAY_TASK_ID in
    0) MODEL=sonata_cp_gcn        ; EXP_NAME="mp_gcn_edgeconv"   ;;
    1) MODEL=sonata_cp_pt_head    ; EXP_NAME="mp_pt_attention"   ;;
    2) MODEL=sonata_cp_meshconv   ; EXP_NAME="mp_mesh_conv"      ;;
    3) MODEL=sonata_cp_diffusion  ; EXP_NAME="mp_diffusion"      ;;
esac
